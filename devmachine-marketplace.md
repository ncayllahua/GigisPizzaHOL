...
9. On your local computer, connect to your instance and create an ssh tunnel for port 5901 (for display number 1): $ ssh -L 5901:localhost:5901 –i id_rsa opc@<IP Address>

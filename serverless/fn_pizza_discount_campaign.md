...
![](./serverless/images/fn-discount-campaign/faas-create-function01.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function02.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function03.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function04.PNG)

A new project will be available as workspace in the IDE

![](./serverless/images/fn-discount-campaign/faas-create-function05.PNG)

You can click in **HelloFunction.java** to review your serverless function code. Same for **HelloFunctionTest.java** file.

![](./serverless/images/fn-discount-campaign/faas-create-function06.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function07.PNG)

Then set the same name as java class **[GetDiscount.java]**

![](./serverless/images/fn-discount-campaign/faas-create-function08.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function09.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function10.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function11.PNG)

Change the name of the java file to **[GetDiscount.java]**.

![](./serverless/images/fn-discount-campaign/faas-create-function12.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function13.PNG)

You should have the java function code, the func.yaml and pom.xml files in your project directory right now.

![](./serverless/images/fn-discount-campaign/faas-create-function14.PNG)
...
```
![](./serverless/images/fn-discount-campaign/faas-create-function15.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function16.PNG)

Then click in File -> Save All in your IDE to save the changes.

![](./serverless/images/fn-discount-campaign/faas-create-function17.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function18.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function19.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes01.PNG)

   - Write **libs** as directory name and press enter to create it.
   
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes02.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes03.PNG)
...
```
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes04.PNG)
```sh
wget "https://github.com/oraclespainpresales/fn_pizza_discount_campaign/raw/master/libs/oraclepki.jar"
```
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes05.PNG)
```sh
wget "https://github.com/oraclespainpresales/fn_pizza_discount_campaign/raw/master/libs/osdt_cert.jar"
```
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes06.PNG)
```sh
wget "https://github.com/oraclespainpresales/fn_pizza_discount_campaign/raw/master/libs/osdt_core.jar"
```
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes07.PNG)
```sh
wget "https://github.com/oraclespainpresales/fn_pizza_discount_campaign/raw/master/libs/ucp.jar"
```
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes08.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes09.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function-jdbc-classes10.PNG)
...
1. If you downloaded it when you created the ATP db, you can upload or copy to your development manchine root project directory.
   ...
   ![](./serverless/images/fn-discount-campaign/faas-create-function-dbwallet01.PNG)
   
   - Select your dbwallet.zip or drag & drop in your fn_discount_campaign directory to copy dbwallet.zip file.
   
   ![](./serverless/images/fn-discount-campaign/faas-create-function-dbwallet02.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function-dbwallet03.PNG)
...
```
![](./serverless/images/fn-discount-campaign/faas-create-function20.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function21.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function22.PNG)

Check that your new function is created in your serverless app [gigis-serverless-hol] at Developer Services -> Functions menu.

![](./serverless/images/fn-discount-campaign/faas-create-function23.PNG)
...
![](./serverless/images/fn-discount-campaign/faas-create-function24.PNG)

...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function01.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function02.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function03.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function04.PNG)

A new project will be available as workspace in the IDE

![](./serverless/images/fn-discount-campaign-pool/faas-create-function05.PNG)

You can click in **HelloFunction.java** to review your serverless function code. Same for **HelloFunctionTest.java** file.

![](./serverless/images/fn-discount-campaign-pool/faas-create-function06.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function07.PNG)

Then set the same name as java class **[GetDiscountPool.java]**

![](./serverless/images/fn-discount-campaign-pool/faas-create-function08.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function09.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function10.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function11.PNG)

Change the name of the java file to **[GetDiscountPool.java]**.

![](./serverless/images/fn-discount-campaign-pool/faas-create-function12.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function13.PNG)

You should have the java function code, the func.yaml and pom.xml files in your project directory right now.

![](./serverless/images/fn-discount-campaign-pool/faas-create-function14.PNG)
...
timeout: 120
```
![](./serverless/images/fn-discount-campaign-pool/faas-create-function15.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function16.PNG)

Then click in File -> Save All in your IDE to save the changes.

![](./serverless/images/fn-discount-campaign-pool/faas-create-function17.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function18.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function19.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function-jdbc-classes01.PNG)
...
```
![](./serverless/images/fn-discount-campaign-pool/faas-create-function-dbwallet03.PNG)
...
```
![](./serverless/images/fn-discount-campaign-pool/faas-create-function20.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function21.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function22.PNG)

Check that your new function is created in your serverless app [gigis-serverless-hol] at Developer Services -> Functions menu.

![](./serverless/images/fn-discount-campaign-pool/faas-create-function23.PNG)
...
![](./serverless/images/fn-discount-campaign-pool/faas-create-function24.PNG)

[![](./serverless/images/image1.png)](https://www.oracle.com/code-one/)
...
![](./serverless/images/imageserverless0001.png)
...
![](./serverless/images/image6.png)

![](./serverless/images/image7.png)
...
![](./serverless/images/image8.png)

Accept the Terms and Conditions:

![](./serverless/images/image9.png)
...
![](./serverless/images/image19.png)

Now go to Menu option Identity-\>Users:

![](./serverless/images/image20.png)
...
![](./serverless/images/vnc-create01.PNG)
...
![](./serverless/images/vnc-create07.PNG)
...
![](./serverless/images/objectstorage-create01.PNG)

Check your campartment name [HandsOnLab] and click Create Bucket button.

![](./serverless/images/objectstorage-create02.PNG)
...
![](./serverless/images/objectstorage-create03.PNG)

Review you new bucket.

![](./serverless/images/objectstorage-create04.PNG)
...
![](./serverless/images/ATP-create01.png)
...
![](./serverless/images/ATP-create02.png)
...
![](./serverless/images/ATP-create03.png)
...
![](./serverless/images/autonomous-transaction-processing.png)

Click DB Connection button to access wallet download and connection Strings menu.

![](./serverless/images/ATP-configure01.PNG)
...
![](./serverless/images/ATP-configure02.PNG)
...
![](./serverless/images/ATP-configure03.PNG)
...
![](./serverless/images/ATP-configure-websql01.PNG)
...
![](./serverless/images/ATP-configure-schema01.PNG)
...
![](./serverless/images/ATP-configure-schema02.PNG)
...
![](./serverless/images/ATP-configure-schema03.PNG)
...
```
![](./serverless/images/ATP-configure-ords01.PNG)
...
END;
```
![](./serverless/images/ATP-configure-ords02.PNG)
...
![](./serverless/images/ATP-configure-ords-url01.PNG)
...
![](./serverless/images/faas-configure-policies01.PNG)
...
![](./serverless/images/faas-configure-policies02.PNG)
...
![](./serverless/images/faas-configure-policies03.PNG)

Review your new Policy to check the sentence.

![](./serverless/images/faas-configure-policies04.PNG)
...
![](./serverless/images/oci-faas-create01.PNG)

Check that your compartment is [HandsOnLab] and click Create Application.

![](./serverless/images/oci-faas-create02.PNG)
...
![](./serverless/images/oci-faas-create03.PNG)
...
![](./serverless/images/oci-faas-create04.PNG)
...
![](./serverless/images/oci-logging-create01.PNG)
...
![](./serverless/images/oci-logging-create03.PNG)
...
![](./serverless/images/oci-logging-create04.PNG)
...
![](./serverless/images/papertrail-configure05.PNG)
...
![](./serverless/images/papertrail-configure06.PNG)

Go to Functions menu and [gigis-serverless-hol] app. Then Click Edit button.

![](./serverless/images/papertrail-configure07.PNG)
...
![](./serverless/images/papertrail-configure08.PNG)
...
![](./serverless/images/faas-create-function01.PNG)
...
![](./serverless/images/faas-create-function01b.PNG)
...
![](./serverless/images/faas-create-function02.PNG)
...
fn list context
```
![](./serverless/images/faas-create-function02b.PNG)
...
```
![](./serverless/images/faas-create-function03.PNG)

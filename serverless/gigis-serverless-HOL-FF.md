...
3. [Review OCI Components](#review-oci-components)  
   - 3.1. [Virtual Developer cloud Machine](#virtual-developer-cloud-machine)
   - 3.2. [ATP - Autonomous Database Review](#atp---autonomous-database-review)
   	  - 3.2.1. [Get ATP Wallet File](#get-atp-wallet-file)
	  - 3.2.2. [ATP-Service Console](#atp-service-console)
   - 3.3. [OCI IAM FaaS Policy Review](#oci-iam-faas-policy-review)	  
   - 3.4. [Oracle FaaS Serverless Application Review](#oracle-faas-serverless-application-review)
	  - 3.4.1. [Function Environment Variables](#function-environment-variables-review)

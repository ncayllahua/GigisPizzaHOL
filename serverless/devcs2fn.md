...
Check updated status by clicking in ![](./images/fn-devcs/image32.png) icon:

![](./images/fn-devcs/image33.png)
...
![](./images/fn-devcs/image52.png)

Now your VM will start creation process

![](./images/fn-devcs/image50.png)
...
![](./images/fn-devcs/image51.png)

![](./images/fn-devcs/image53.png)
...
![](./images/fn-devcs/devcs-projectcreation-newproject01.PNG)

Select Empty Project and Click Next button.

![](./images/fn-devcs/devcs-projectcreation-newproject02.PNG)

Click Finish to create the new project.

![](./images/fn-devcs/devcs-projectcreation-newproject03.PNG)

Wait to project environment creation (about 2 or 3 minutes)

![](./images/fn-devcs/devcs-projectcreation-newproject04.PNG)
...
![](./images/fn-devcs/devcs-project-create-git-repo01.PNG)

New GIT repo will be created with a README.md file only.

![](./images/fn-devcs/devcs-project-create-git-repo02.PNG)
...
![](./images/fn-devcs/devcs-project-create-git-repo03.PNG)
...
![](./images/fn-devcs/fn-devcs-gitclone00.png)

Check that your entire serverless project was loaded in your IDE (vs code).

![](./images/fn-devcs/fn-devcs-gitclone01.png)
...
![](./images/fn-devcs/fn-devcs-gitclone05.png)
...
![](./images/fn-devcs/fn-devcs-gitclone06.png)
...
![](./images/fn-devcs/fn-devcs-gitclone07.png)
...
![](./images/fn-devcs/fn-devcs-gitclone13.png)
...
![](./images/fn-devcs/fn-devcs-gitclone14.png)

Next you must click in the **commit** icon at the top of the SCRM menu.

![](./images/fn-devcs/fn-devcs-gitclone15.png)

Next click Yes button to execute the commit.

![](./images/fn-devcs/fn-devcs-gitclone16.png)
...
![](./images/fn-devcs/fn-devcs-gitclone19.png)
...
![](./images/fn-devcs/fn-devcs-gitclone20.png)
...
![](./images/fn-devcs/fn-devcs-gitclone21.png)

Repeat this process to the other two serverless functions. **fn_discount_cloud_events**

![](./images/fn-devcs/fn-devcs-gitclone22.png)

And **fn_discount_campaign**

![](./images/fn-devcs/fn-devcs-gitclone23.png)

Optionally **fn_discount_campaign_pool**

![](./images/fn-devcs/fn-devcs-gitclone24.png)
...
![](./images/fn-devcs/fn-devcs-jobs01.png)
...
![](./images/fn-devcs/fn-devcs-jobs05.png)
...
![](./images/fn-devcs/fn-devcs-jobs06.png)
...
![](./images/fn-devcs/fn-devcs-jobs07.png)
...
![](./images/fn-devcs/fn-devcs-jobs08.png)
...
![](./images/fn-devcs/fn-devcs-jobs09.png)

Next you will create a new step. Select Add Step -> Fn -> Fn OCI

![](./images/fn-devcs/fn-devcs-jobs10.png)
...
![](./images/fn-devcs/fn-devcs-jobs11.png)
...
![](./images/fn-devcs/fn-devcs-jobs12.png)
...
```
![](./images/fn-devcs/fn-devcs-jobs13.png)
...
![](./images/fn-devcs/fn-devcs-jobs14.png)
...
![](./images/fn-devcs/fn-devcs-jobs15.png)
...
![](./images/fn-devcs/fn-devcs-jobs16.png)
...
![](./images/fn-devcs/fn-devcs-jobs17.png)
...
![](./images/fn-devcs/fn-devcs-jobs18.png)

Drag and drop your jobs to the drawing area.

![](./images/fn-devcs/fn-devcs-jobs19.png)
...
![](./images/fn-devcs/fn-devcs-jobs20.png)
...
![](./images/fn-devcs/fn-devcs-jobs23.png)
...
![](./images/fn-devcs/fn-devcs-jobs24.png)
...
![](./images/fn-devcs/fn-devcs-jobs25.png)
...
![](./images/fn-devcs/fn-devcs-jobs30.png)
...
![](./images/fn-devcs/fn-devcs-jobs40.png)
...
![](./images/fn-devcs/fn-devcs-jobs41.png)
...
![](./images/fn-devcs/fn-devcs-jobs37.png)
...
![](./images/fn-devcs/fn-devcs-jobs38.png)

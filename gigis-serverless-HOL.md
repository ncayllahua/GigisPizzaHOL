...
4. [Create OCI Resources](#create-oci-resources)
   ...
   - 4.4 [ATP - Autonomous Database Creation](#atp---autonomous-database-creation)
	 ...
	 - 4.4.3. [ATP Schema and Tables Creation](#atp-schema-and-tables-creation)
	 - 4.4.4. [ATP ORDS Configuration](#atp-ords-configuration)
	 - 4.4.5. [ATP Enable ORDS Table](#atp-enable-ords-table)
   - 4.5. [OCI IAM FaaS Policy](#vcn---virtual-cloud-network-creation)
   - 4.6. [Oracle FaaS Serverless Application Creation](#oracle-faas-serverless-application-creation)
